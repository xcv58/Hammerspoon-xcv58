...
local editorAndIDEs = {{"Atom Beta", "org.vim.MacVim", "Emacs", "com.jetbrains.intellij.ce", "com.jetbrains.intellij", "Xcode"}}
local emails = {{"Mailplane 3", "Kiwi for Gmail"}}
local chats = {{"Slack", "WeChat", "Messages", "FaceTime"}}
